...
Variant LBFluidNode::do_call_method(std::string const &name,
  ...
  if (name == "get_density") {
    ...
    return Utils::Mpi::reduce_optional(context()->get_comm(), result) / m_conv_dens;
  }
  if (name == "set_density") {
  ...
  if (name == "get_velocity") {
    ...
    return Utils::Mpi::reduce_optional(context()->get_comm(), result) / m_conv_velocity;
  }
  ...
  if (name == "get_boundary_force") {
    ...
    if (is_boundary_all_reduce(context()->get_comm(), boundary_opt)) {
      ...
      return Utils::Mpi::reduce_optional(context()->get_comm(), result) / m_conv_force;
    }
    return Variant{None{}};
  }

...
class CheckpointTest(ut.TestCase):
    ...
    def setUpClass(self):
        checkpoint = espressomd.checkpointing.Checkpoint(
            ...
            checkpoint_path="/home/areinauer/Documents/hiwi/espresso/cmake-build-debug/testsuite/python")
        checkpoint.load(0)
        if espressomd.has_features('LB'):
            self.lbf = system.actors[0]
            self.lbf.load_checkpoint("/home/areinauer/Documents/hiwi/espresso/cmake-build-debug/testsuite/python/lb.cpt", 1)
